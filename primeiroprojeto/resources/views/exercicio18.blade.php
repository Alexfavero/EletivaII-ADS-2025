...
<body>
    <div class="container">
        <h1>Exercicio 18</h1>
        <form method="post" action="/resposta_exercicio18">
            @CSRF
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="valor3" class="form-label">Periodo (meses)</label>
                <input type="float" id="valor3" name="valor3" class="form-control" required="">
            </div>
